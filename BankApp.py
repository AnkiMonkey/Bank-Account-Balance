...
final_output_file = f'bank_report_{month}_{year}.xlsx'
...
bars = plt.barh(['Profits', 'Expenses', 'Total'], [positive_sum_euros, negative_sum_euros, total_sum_euros], color=['green', 'red', 'blue'])
